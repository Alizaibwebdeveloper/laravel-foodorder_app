    ...
    <div class="">
        ...
        <div class="row mb-5">
            <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                <input type="text" id="booktable" name="phone" class="form-control form-control-lg custom-form-control" placeholder="PHONE NUMBER">
            </div>
            <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                <input type="number" id="booktable" class="form-control form-control-lg custom-form-control" placeholder="NUMBER OF GUESTS" name="n_guest" max="20" min="0">
            </div>
            <div class="col-sm-6 col-md-3 col-xs-12 my-2">
        ...
        <input type="submit" href="#" class="btn btn-lg btn-primary" id="rounded-btn" value="Book Table"></input>
