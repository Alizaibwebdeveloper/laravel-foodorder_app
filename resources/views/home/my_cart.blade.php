...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <!-- Navbar --><nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
...
<div id="gallary" class="text-center bg-dark text-light has-height-md middle-items wow fadeIn">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-danger" href="{{url('remove_cart',$data->id)}}">Remove</a>
            </td>
        </tr>
...
<div class="div_center">
    ...
    <form action="{{url('confirm_order')}}" method="POST">
        ...
        <div class="div_deg">
            ...
            <input name="address" value="{{Auth()->user()->address}}"></input>
        </div>
